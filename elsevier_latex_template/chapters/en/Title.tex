...
\tnotetext[titlenote]{This article is a starting point for development of an IP- module of automatic gain quadrature signal, namely, the device, resulting in an average level is an arbitrary signal to the desired at a predetermined time interval (what's a horror! change it, please, to be clear!). The device is intended for using in Vivado package and is focused on the implementation on the basis of FPGA logic programming company Xilinx family - 7.}
